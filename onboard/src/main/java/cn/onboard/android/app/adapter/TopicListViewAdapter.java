...
public class TopicListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.author.setText((topic.getExcerpt().length() > 20) ? (topic.getExcerpt().substring(0, 15) + "……") : topic.getExcerpt());
        listItemView.count.setText(new PrettyTime(new Locale("zh")).format(topic.getCreated()));
