...
public class ActivityFragment extends Fragment implements
	...
	public ActivityFragment(int companyId, int projectId) {
		this();
		...
		activiPullToRefreshListView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
						...
						// }else{
						// TextView tv =
						// (TextView)view.findViewById(R.id.question_listitem_title);
						// post = (Post)tv.getTag();
						// }
						// if(post == null) return;
						//
		...
		new Thread() {
			public void run() {
				...
				try {
					...
					returnedActivities = ac.getActivitiesByProjectId(companyId,
							projectId, pageIndex);
